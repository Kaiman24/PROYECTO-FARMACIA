...
namespace FarmaciaDevExtreme.Controllers
{
    public class ClienteController : ApiController
    {
        ...
        loadOptions)
        {
            var apiUrl = "https://localhost:44329/api/Clientes/";
            var respuestaJson = await GetAsync(apiUrl);
            //System.Diagnostics.Debug.WriteLine(respuestaJson);

            List<Cliente> listaProducto = JsonConvert.DeserializeObject<List<Cliente>>(respuestaJson);
            return
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            var url = "https://localhost:44329/api/Clientes/";
        ...
        form)
        {
            ...
            var apiUrlGetPeli = "https://localhost:44329/api/Clientes/" + key;
            var respuestaPelic = await GetAsync(apiUrlGetPeli = "https://localhost:44329/api/Clientes/" + key);
            Cliente producto = JsonConvert.DeserializeObject<Cliente>(respuestaPelic);
            JsonConvert.PopulateObject(values, producto);
            string jsonString = JsonConvert.SerializeObject(producto);
            var httpContent = new StringContent(jsonString, System.Text.Encoding.UTF8, "application/json");
            var url = "https://localhost:44329/api/Clientes/" + key;
        ...
        public async Task<HttpResponseMessage> Delete(FormDataCollection form)
        {
            ...
            var apiUrlDelPeli = "https://localhost:44329/api/Clientes/"
                + key;
