...
namespace FarmaciaDevExtreme.Controllers
{
    public class DetalleFacturaController : ApiController
    {
        ...
        loadOptions)
        {
            var apiUrl = "https://localhost:44329/api/DetalleFacturas/";
            var respuestaJson = await GetAsync(apiUrl);
            //System.Diagnostics.Debug.WriteLine(respuestaJson);

            List<DetalleFactura> listaProducto = JsonConvert.DeserializeObject<List<DetalleFactura>>(respuestaJson);
            return
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            var url = "https://localhost:44329/api/DetalleFacturas/";
        ...
        form)
        {
            ...
            var apiUrlGetPeli = "https://localhost:44329/api/DetalleFacturas/" + key;
            var respuestaPelic = await GetAsync(apiUrlGetPeli = "https://localhost:44329/api/DetalleFacturas/" + key);
            DetalleFactura producto = JsonConvert.DeserializeObject<DetalleFactura>(respuestaPelic);
            JsonConvert.PopulateObject(values, producto);
            string jsonString = JsonConvert.SerializeObject(producto);
            var httpContent = new StringContent(jsonString, System.Text.Encoding.UTF8, "application/json");
            var url = "https://localhost:44329/api/DetalleFacturas/" + key;
        ...
        public async Task<HttpResponseMessage> Delete(FormDataCollection form)
        {
            ...
            var apiUrlDelPeli = "https://localhost:44329/api/DetalleFacturas/"
                + key;
