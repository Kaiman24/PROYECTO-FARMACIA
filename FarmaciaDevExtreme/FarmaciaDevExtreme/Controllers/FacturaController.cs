...
namespace FarmaciaDevExtreme.Controllers
{
    public class FacturaController : ApiController
    {
        ...
        loadOptions)
        {
            var apiUrl = "https://localhost:44329/api/Facturas/";
            var respuestaJson = await GetAsync(apiUrl);
            //System.Diagnostics.Debug.WriteLine(respuestaJson);

            List<Factura> listaProducto = JsonConvert.DeserializeObject<List<Factura>>(respuestaJson);
            return
        ...
        public async Task<HttpResponseMessage> Post(FormDataCollection form)
        {
            ...
            var url = "https://localhost:44329/api/Facturas/";
        ...
        form)
        {
            ...
            var apiUrlGetPeli = "https://localhost:44329/api/Facturas/" + key;
            var respuestaPelic = await GetAsync(apiUrlGetPeli = "https://localhost:44329/api/Facturas/" + key);
            Factura producto = JsonConvert.DeserializeObject<Factura>(respuestaPelic);
            JsonConvert.PopulateObject(values, producto);
            string jsonString = JsonConvert.SerializeObject(producto);
            var httpContent = new StringContent(jsonString, System.Text.Encoding.UTF8, "application/json");
            var url = "https://localhost:44329/api/Facturas/" + key;
        ...
        public async Task<HttpResponseMessage> Delete(FormDataCollection form)
        {
            ...
            var apiUrlDelPeli = "https://localhost:44329/api/Facturas/"
                + key;
